...
router.post("/coddoc", async(req,res)=>{
    ...
    switch (tipo.toString()) {
        case 'FAC':
            qry = `SELECT CODDOC FROM TIPODOCUMENTOS WHERE EMPNIT='${sucursal}' AND TIPODOC='FAC' AND ACTIVO='SI';`
            break;
        case 'FEL':
            qry = `SELECT CODDOC FROM TIPODOCUMENTOS WHERE EMPNIT='${sucursal}' AND TIPODOC IN('FEF','FEC') AND ACTIVO='SI';`
            break;

        default:
            qry = `SELECT CODDOC FROM TIPODOCUMENTOS WHERE EMPNIT='${sucursal}' AND TIPODOC='${tipo}' AND ACTIVO='SI';`
            break;
    }
